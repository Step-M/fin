...
!(function (t, i, e) {
    ...
    var r =
        ...
        h = (function () {
            ...
            var h = s("transform");
            return (
                o.extend(o, { hasTransform: h !== !1, hasPerspective: s("perspective") in n, hasTouch: "ontouchstart" in t, hasPointer: !(!t.PointerEvent && !t.MSPointerEvent), hasTransition: s("transition") in n }),
                ...
                o.extend((o.style = {}), { transform: h, transitionTimingFunction: s("transitionTimingFunction"), transitionDuration: s("transitionDuration"), transitionDelay: s("transitionDelay"), transformOrigin: s("transformOrigin") }),
    ...
    (s.prototype = {
                ...
                if (((this.isInTransition = 0), (this.initiated = 0), (this.endTime = h.getTime()), !this.resetPosition(this.options.bounceTime))) {
                    ...
                    if (
                        (this.options.momentum &&
                            o < 300 &&
                            ((i = this.hasHorizontalScroll ? h.momentum(this.x, this.startX, o, this.maxScrollX, this.options.bounce ? this.wrapperWidth : 0, this.options.deceleration) : { destination: n, duration: 0 }),
                            (s = this.hasVerticalScroll ? h.momentum(this.y, this.startY, o, this.maxScrollY, this.options.bounce ? this.wrapperHeight : 0, this.options.deceleration) : { destination: r, duration: 0 }),
                            (n = i.destination),
                            (r = s.destination),
        ...
        _initEvents: function (i) {
            ...
            e(t, "orientationchange", this),
                ...
                h.hasPointer &&
                    ...
                    (e(this.wrapper, h.prefixPointerEvent("pointerdown"), this), e(s, h.prefixPointerEvent("pointermove"), this), e(s, h.prefixPointerEvent("pointercancel"), this), e(s, h.prefixPointerEvent("pointerup"), this)),
        ...
        getComputedPosition: function () {
            ...
            return (
                this.options.useTransform ? ((s = s[h.style.transform].split(")")[0].split(", ")), (i = +(s[12] || s[4])), (e = +(s[13] || s[5]))) : ((i = +s.left.replace(/[^-\d.]/g, "")), (e = +s.top.replace(/[^-\d.]/g, ""))),
                { x: i, y: e }
            );
        },
        ...
        goToPage: function (t, i, s, o) {
            ...
            var n = this.pages[t][i].x,
                r = this.pages[t][i].y;
            (s = void 0 === s ? this.options.snapSpeed || e.max(e.max(e.min(e.abs(n - this.x), 1e3), e.min(e.abs(r - this.y), 1e3)), 300) : s), (this.currentPage = { x: n, y: r, pageX: t, pageY: i }), this.scrollTo(n, r, s, o);
        },
        next: function (t, i) {
